...
Clima is a Python package that helps to parse and encapsulate command-line arguments into a container that you declare as a simple schema class. It's opinionated in favour of minimal configuration in contrast to other cli frameworks.
